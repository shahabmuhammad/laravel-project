<nav class="navbar header bg-white shadow-sm">
    <div class="container-fluid">
        ...
        <button class="btn btn-link d-lg-none" id="menu-toggle" aria-label="Toggle sidebar navigation">
        ...
        <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                <a class="text-dark position-relative" href="#" id="notificationDropdown" role="button"
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="notificationDropdown"
                    ...
                    @empty
                        <li>
                            <p class="dropdown-item text-muted mb-0">No notifications yet</p>
                        </li>
                    @endforelse
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item text-center fw-semibold text-primary"
                            href="{{ route('admin.notifications.index') }}">View All</a></li>
                </ul>
            </div>
